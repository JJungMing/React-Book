...
export type CardProps = DivProps & {card: D.ICard}

const Card: FC<CardProps> = ({card, ...props}) => {
  const {writer, image, title, paragraphs, dayMonthYearDate, relativeData} = card
      ...
      <div className="flex flex-col overflow-scroll">
        ...
        <Div className="p-4" minHeight="16rem" height="16rem" maxHeight="16rem">
          ...
          <Div className="flex justify-between">
            ...
            <Div className="mt-2">
              <p className="text-gray-500">{relativeData}</p>
