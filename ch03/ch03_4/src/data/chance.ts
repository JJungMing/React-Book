...
export const randomTitleText = (words = 3) => chance.sentence({words}) // 무작위 제목 텍스트를 생성하는 함수, 매개변수로 단어 수를 지정할 수 있음
export const randomParagraphs = (sentences = 3) => chance.paragraph({sentences}) // 무작위 단락을 생성하는 함수, 매개변수로 문장 수를 지정할 수 있음
